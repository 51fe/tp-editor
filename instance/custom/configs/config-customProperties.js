window.tpeditor_config.customProperties = {};
...
(function () {
  /* var valueTypes = {
      ...
      'URL': ['路径', 'assets/hightopo.png'],
      'Multiline': ['多行文本', 'TP Editor\nwww.riafan.com'],
      'Boolean': ['布尔', 'true'],
      'Color': ['颜色', 'red'],
      ...
      'ObjectArray': ['对象数组', [{ company: 'XXX' }, { product: 'TP Editor' }]],
  ...
  var customProperties = window.tpeditor_config.customProperties = {};
