...
window.tpeditor_config.dataBindings = {
  // getToolTip: function(accessType, name, dataBinding, insepctor) {
  //     if (dataBinding && dataBinding.description) {
  //         return dataBinding.description;
  //     }
  //     return accessType + ':' + name;
  // },
  // filter: function(accessType, name, dataBinding, insepctor) {
  //     if (accessType === 's' && name === 'icons') return false;
  //     return true;
  // },
  onButtonClicked: function (data, accessType, name) {
    ...
    formPane.addRow([
      ...
      {
        id: 'textArea',
        element: new tpeditor.CodeEditor({
          value: tpeditor.stringifyFunction(func),
          language: 'javascript',
          minimap: {
            enabled: false
          }
    ...
    var buttons = [{
      ...
      action: function () {
        ...
        if (!id) {
          ...
          dataBindings[accessType][name].func = tpeditor.parseFunction(func);
        }
